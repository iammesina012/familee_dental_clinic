      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            // Title and subtitle with responsive container
            Positioned(
              top: 100,
              left: 0,
              right: 0,
            ...
            // Input fields and button with responsive container
            Positioned(
              top: 220,
              left: 0,
              right: 0,
              child: ResponsiveContainer(
                child: Column(
                  children: [
                    ...
                    // Token field with responsive constraints
                    Container(
                    ...
                    // Resend functionality with responsive constraints
                    Container(
                      width: double.infinity,
                      constraints: BoxConstraints(
                        maxWidth: ResponsiveLayout.isTablet(context) ||
                    ...
                    // New Password field with responsive constraints
                    Container(
                      width: double.infinity,
                      constraints: BoxConstraints(
                        maxWidth: ResponsiveLayout.isTablet(context) ||
                    ...
                    // Confirm Password field with responsive constraints
                    Container(
                      width: double.infinity,
                      constraints: BoxConstraints(
                        maxWidth: ResponsiveLayout.isTablet(context) ||
                    ...
                    // Password Tips Section with responsive constraints
                    Container(
                      width: double.infinity,
                      constraints: BoxConstraints(
                        maxWidth: ResponsiveLayout.isTablet(context) ||
                    ...
                    // Reset Password Button with responsive constraints
                    Container(
                      width: double.infinity,
                      height: 44,
                      constraints: BoxConstraints(
