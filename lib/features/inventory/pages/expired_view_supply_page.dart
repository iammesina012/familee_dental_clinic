                  ...
                  children: [
                    SingleChildScrollView(
                      ...
                      padding: EdgeInsets.symmetric(
                        ...
                        vertical:
                            MediaQuery.of(context).size.width < 768 ? 12 : 16,
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            (updatedItem.type != null &&
                                    updatedItem.type!.trim().isNotEmpty)
                              ...
                              Expanded(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(height: 4),
                                    Text(
                                        "₱${updatedItem.cost.toStringAsFixed(2)}",
                                        style: theme.textTheme.bodyMedium
                                            ?.copyWith(
                                                fontWeight: FontWeight.w500,
                                                fontSize: 15),
                          ...
                          // Other Expired Batches Section (always render panel per Settings/Edit Profile reference)
                          Container(
              ...
              children: [
                Expanded(
                  child: ElevatedButton(
                    onPressed: () async {
                      // Require internet connection for delete
                      final hasConnection =
